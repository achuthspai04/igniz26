...
export default function KhelGyanRegisterPage() {
    ...
    return (
        <div className="relative w-full overflow-x-hidden bg-[#2B0000] min-h-screen flex flex-col font-sans text-white">
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center px-4 pt-20 md:pt-32 pb-12 md:pb-20 max-w-7xl mx-auto w-full">
                <div className="w-full mb-12 md:mb-20">
                    ...
                    <div className="lg:hidden relative flex items-center justify-center mb-8">
                        <div className="relative w-[250px] h-[330px] sm:w-[300px] sm:h-[400px]">
                            <Image src="/events/eventpages/7.webp" alt="Khel Gyan" fill className="object-contain" />
                        </div>
                    </div>
                    <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        <div className="space-y-6 md:space-y-8 lg:col-span-7">
                            <div className="w-full">
                                <Image src="/events/eventpages/7-text.webp" alt="Competition Description" width={800} height={300} className="w-full h-auto" />
                            </div>
                ...
                <section className="w-full mb-16">
                    ...
                    <ul className="list-none space-y-2 text-sm md:text-base font-bold uppercase tracking-tight text-white/90">
                        <li>1. The quiz will consist of multiple rounds with different formats.</li>
                        <li>2. Team size and number of rounds will be announced on the spot.</li>
                        <li>3. Use of mobile phones or any electronic gadgets is strictly prohibited during the quiz.</li>
                        <li>4. The quizmaster&apos;s decision on the validity of answers is final.</li>
                        <li>5. Any team found engaging in unfair practices will be immediately disqualified.</li>
                        <li>6. Participants must maintain discipline and decorum throughout the event.</li>
                    </ul>
                </section>
                <section className="w-full mb-16">
            ...
            <RegistrationPopup isOpen={isRegisterOpen} onClose={() => setIsRegisterOpen(false)} ticketOptions={ticketOptions} eventName="KHEL GYAN" />
            <Footer />
        </div>
    );
}
