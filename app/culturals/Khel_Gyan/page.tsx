...
const PRELOAD_ASSETS = [
    ...
    "/events/eventpages/7.svg",
    "/events/eventpages/7-text.svg",
                ...
                <main className="relative z-10 flex-1 flex flex-col items-center px-4 pt-20 md:pt-32 pb-12 md:pb-20 max-w-7xl mx-auto w-full">
                        ...
                        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                            <div className="space-y-6 md:space-y-8 lg:col-span-7">
                                <div className="w-full">
                                    <Image
                                        src="/events/eventpages/7-text.svg"
                    ...
                    <section className="w-full mb-16">
                        ...
                        <ul className="list-none space-y-2 text-sm md:text-base font-bold uppercase tracking-tight text-white/90">
                            <li>1. Participants can form teams of 1–2 members. (Cross-college teams are permitted.)</li>
                            <li>2. A preliminary round will be conducted, and top-performing teams will advance to the final round.</li>
                            <li>3. In the event of any disputes, the Quiz Master’s decision will be final and binding.</li>
                            <li>4. On-spot registration will be available.</li>
                            <li>5. Any instance of cheating will result in the disqualification of the entire team.</li>
                        </ul>
                    </section>
